...
base.language =
{
    [ 'en' ] =
    {
        ...
        lib_cs_col_hash                     = 'Hash',
        lib_cs_col_algorithm                = 'Algorithm',
        ...
        rcc_chglog_err                      = 'Missing .app/changelog.json',
        ...
        checksum_json_missing               = 'Using Steam Workshop Library',
        lib_integrity_missing               = 'Checksum dictionary missing -- cannot validate integrity.\n Did you modify the code?',
        ...
        debug_push_title                    = 'Debug Status',
        debug_push_status_enabled           = 'Debug Enabled',
        ...
        cs_verify_algorithm                 = 'Hash Algorithm: %s',
        files_checksum_now                  = 'A current list of files and their verified checksums',
        files_modified_count                = 'files modified',
        files_modified_instructions_1       = 'Download a new copy of',
        files_modified_instructions_2       = 'Overwrite the files listed above with new copies taken from the %s .zip.',
        files_registered_count              = '%i files registered',
        ...
        tip_konsole_clear                   = 'clear text',
        tip_konsole_cfg                     = 'settings',
        console                             = 'Console',
        ...
        lang_sel_desc                       = 'Select a language switch your interface translations. Changes take affect immediately when selected.',
        ...
        restart_status                      = 'Restart Pending',
        ...
        tip_reports_clear                   = 'clear text',
        tip_reports_submit                  = 'submit report',
        tip_close                           = 'close',
        tip_minimize                        = 'minimize',
        tip_refresh_data                    = 'refresh data',
        ...
        setup_root_new_title                = 'Registration Complete',
        setup_root_exists_title             = 'Already Registered',
        setup_root_exists_msg               = 'Server is registered to user » %s',
