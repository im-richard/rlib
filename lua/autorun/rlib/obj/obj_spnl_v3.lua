...
function PANEL:Init( )
    ...
    */
    ...
    self.VBar                       = ui.new( 'rlib.elm.sb.v3', self        )
    :right                          (                                       )
    ...
    */
    ...
    :param                          ( 'SetAlwaysVisible', true              )
                                    ...
                                    :draw( function( s, w, h )
                                        ...
                                        design.rbox( 4, 8, 10, 4, h - 20, Color( clr_tr.r, clr_tr.g, clr_tr.b, self:GetbKonsole( ) and self.KAlpha or clr_tr.a ) )
                                    end )
    ...
    */
    ...
    :var                            ( 'alpha', 0                            )
                                    ...
                                    :draw( function( s, w, h )
                                        ...
                                        design.rbox( 4, 0, 0, 20, h, Color( clr_sl.r, clr_sl.g, clr_sl.b, alpha ) )
                                    end )
...
function PANEL:SetTrackColor( clr )
    self.clr_track = IsColor( clr ) and clr or cfg.elm.clrs.sbar_track_v3
end
...
function PANEL:GetTrackColor( )
    return IsColor( self.clr_track ) and self.clr_track or cfg.elm.clrs.sbar_track_v3
end
...
function PANEL:SetGripColor( clr )
    self.clr_grip = IsColor( clr ) and clr or cfg.elm.clrs.sbar_grip_v3
end
...
function PANEL:GetGripColor( )
    return IsColor( self.clr_grip ) and self.clr_grip or cfg.elm.clrs.sbar_grip_v3
end
...
vgui.Register( 'rlib.ui.spnl.v3', PANEL, 'DPanel' )
vgui.Register( 'rlib.elm.sp.v3', PANEL, 'DPanel' )